  ...
  return (
    <>
      ...
      <main className="flex-grow">
        ...
        {/* Mission — Vision — Values with Modals */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-stretch">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-2xl font-black text-slate-900 tracking-tight mb-3">Delivering Innovative Healthcare Solutions</h3>
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-2xl font-black text-slate-900 tracking-tight mb-3">Building a Healthier Future Together</h3>
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-2xl font-black text-slate-900 tracking-tight mb-3">Integrity, Quality & Innovation</h3>
              ...
              <div className="relative hidden lg:block h-full">
                <div className="rounded-3xl overflow-hidden shadow-xl h-full">
                  <img src="/AboutImage3.avif" alt="MG Laboratories" className="w-full h-full object-cover" />
                </div>
